...
# Zigchain MacOS ARM Testnet Setup Script
# This script sets up a ZIGChain testnet node on MacOS ARM systems (Apple Silicon)

echo "🚀 Starting ZIGChain MacOS ARM Testnet Setup..."
...
curl -O https://raw.githubusercontent.com/ZIGChain/networks/refs/heads/main/zig-test-2/genesis.json || { 
