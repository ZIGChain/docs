...
# Zigchain MacOS AMD Testnet Setup Script
# This script sets up a ZIGChain testnet node on MacOS AMD systems (Intel Macs)

echo "🚀 Starting ZIGChain MacOS AMD Testnet Setup..."
