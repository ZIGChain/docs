...
# Zigchain Linux Mainnet Setup Script
# This script sets up a ZIGChain mainnet node on Linux systems

echo "🚀 Starting ZIGChain Linux Mainnet Setup..."
...
wget -q https://raw.githubusercontent.com/ZIGChain/networks/refs/heads/main/zigchain-1/genesis.json \
