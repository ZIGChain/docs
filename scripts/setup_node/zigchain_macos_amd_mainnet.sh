...
# Zigchain MacOS AMD Mainnet Setup Script
# This script sets up a ZIGChain mainnet node on MacOS AMD systems (Intel Macs)

echo "🚀 Starting ZIGChain MacOS AMD Mainnet Setup..."
