...
- Cosmos Account Definition: [https://docs.cosmos.network/v0.46/basics/accounts.html](https://docs.cosmos.network/v0.46/basics/accounts.html)
- Explanation about Mnemonic Phrase (BIP-39): [https://www.blockplate.com/pages/bip-39-wordlist](https://www.blockplate.com/pages/bip-39-wordlist)
- Ethereum accounts: [https://ethereum.org/en/whitepaper/\#ethereum-accounts](https://ethereum.org/en/whitepaper/#ethereum-accounts)
