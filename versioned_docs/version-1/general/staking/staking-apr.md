...
| `community_tax`       | Portion of staking rewards allocated for network development and governance. More [here](../../build/distribution-module). |
| `inflation` rate      | Percentage of tokens issued annually relative to the [total supply](../zig#zig-token-distribution).                        |
