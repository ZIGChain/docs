...
Users can check the current status of a proposal on [ZIGChain Hub](https://hub.zigchain.com/proposals/) or using CLI commands like:
...
- [ZIGChain HUB - Staking](https://hub.zigchain.com/staking/)
- [Staking](./staking.md)
