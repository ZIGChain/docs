---
title: ZigchainAddressAvatar Component
description: Documentation for the ZigchainAddressAvatar React component that generates unique gradient-based avatars for ZIGChain addresses for visual representation in UIs.
keywords:
  [
