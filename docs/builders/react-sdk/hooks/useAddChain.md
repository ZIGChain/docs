---
title: useAddChain Hook
description: Documentation for the useAddChain React hook that adds ZIGChain network (mainnet or testnet) to compatible wallets like Keplr or Leap, with installation URL support.
keywords:
  [
    useAddChain,
    React hook,
