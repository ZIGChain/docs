---
title: useZigchainClient Hook
description: Documentation for the useZigchainClient React hook that provides direct access to the ZIGChain client for performing queries, transactions, and blockchain operations.
keywords:
  [
    useZigchainClient,
    React hook,
