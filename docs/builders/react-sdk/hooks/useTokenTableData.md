---
title: useTokenTableData Hook
description: Documentation for the useTokenTableData React hook that retrieves paginated token data from ZIGChain with enriched metadata, ideal for displaying tokens in table format.
keywords:
  [
    useTokenTableData,
    React hook,
