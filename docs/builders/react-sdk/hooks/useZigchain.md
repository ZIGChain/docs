---
title: useZigchain Hook
description: Documentation for the useZigchain React hook that provides wallet connection, address management, transaction signing, and ZIGChain blockchain interaction in React applications.
keywords:
  [
    useZigchain,
    React hook,
