---
title: useCreateToken Hook
description: Documentation for the useCreateToken React hook that simplifies creating new tokens on ZIGChain, handling denomination creation, metadata setting, and token minting in a single interface.
keywords:
  [
    useCreateToken,
    React hook,
