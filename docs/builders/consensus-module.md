...
The ZIGChain Consensus Module is based on the [Cosmos SDK - Consensus Module](https://docs.cosmos.network/main/build/modules/consensus) but with the specific parameters that you can find in the [Consensus Parameters](#consensus-parameters) section.
...
- [Cosmos SDK - Consensus Module](https://docs.cosmos.network/main/build/modules/consensus)

- [Tendermint - Genesis](https://docs.tendermint.com/master/spec/core/genesis.html#genesis)

- [CometBFT - Consensus Parameters](https://docs.cometbft.com/v1.0/spec/abci/abci++_app_requirements#consensus-parameters)
