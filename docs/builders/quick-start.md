...
:::warning
These mnemonics are for **LOCAL DEVELOPMENT ONLY** (`chain-id: zigchain-1`).
Do not use these keys on testnet or mainnet - they are publicly known and any funds sent to these addresses can be accessed by anyone.
:::
