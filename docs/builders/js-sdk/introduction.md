---
title: ZIGChain JS SDK
description: Introduction to ZIGChain JS SDK for building frontend and backend applications. Learn about features, installation, message composition, and transaction broadcasting.
keywords:
  [
    ZIGChain JS SDK,
    ZIGChain SDK,
    ...
    ZIGChain wallet integration,
    ZIGChain cosmos-kit integration,
    build dApp on ZIGChain SDK,
    ZIGChain token swap/client SDK,
    ZIGChain contract messaging via SDK,
    ZIGChain SDK quick start,
    ZIGChain custom network support,
    ZIGChain mainnet SDK,
  ]
sidebar_position: 1
---
...
ZIGChain provides two Software Development Kits (SDKs) for building applications on top of its blockchain: [ZIGChain SDK](../react-sdk/introduction) and **ZIGChain SDK JS** to build on top of ZIGChain. Below is a comparison to help you to choose the right SDK based on their project requirements:
...
const { createDenom, setDenomMetadata, mintAndSendTokens } =
  zigchain.factory.MessageComposer.withTypeUrl;
```
