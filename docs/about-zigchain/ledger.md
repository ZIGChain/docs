...
description: Complete guide to setting up and using Ledger hardware wallet with ZIGChain, including Cosmos app installation, Keplr integration, and troubleshooting tips.
keywords:
  [
    Ledger wallet,
    hardware wallet,
...
- You have ZIG tokens in ZIGChain format (not ERC20). If your ZIG is still on Ethereum, you need to bridge it first. See [Bridge Tokens](../users/hub/bridge).
