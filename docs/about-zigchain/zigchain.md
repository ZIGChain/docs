...
description: Learn about ZIGChain, a Layer 1 blockchain built on Cosmos SDK that enables wealth generation protocols and provides excellent developer experience with fast, affordable transactions.
keywords:
  [
    ZIGChain overview,
    what is ZIGChain,
    ZIGChain Layer 1 blockchain,
    ZIGChain mainnet,
    ZIGChain wealth generation infrastructure,
    ZIGChain RWA tokenization,
    ZIGChain Cosmos SDK chain,
    what is ZIGChain used for,
    why choose ZIGChain blockchain,
    ZIGChain ecosystem explained,
    is ZIGChain a Layer 1,
    ZIGChain benefits for investors,
    ZIGChain blockchain summary,
  ]
sidebar_position: 1
---
