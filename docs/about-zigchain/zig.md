---
title: The ZIG Token
description: Complete guide to ZIG, the native utility token of ZIGChain. Learn about tokenomics, utilities, distribution, exchanges, and how ZIG powers consensus, governance, and DeFi activities.
keywords:
  [
    ZIG token,
    ...
    ZIG token utility,
    ZIG token staking,
    ZIG token governance,
    ZIG token gas fees,
    what is ZIG token,
    how ZIG token works,
    ZIG token utilities explained,
    ZIG token distribution,
    ZIG token staking rewards,
    use ZIG token for gas,
  ]
sidebar_position: 2
---
...
The following table shows which exchanges support ZIG tokens across different networks:

| Exchange                                                           | ZIGChain | Ethereum Network<br/>(ERC20) | Binance Smart Chain<br/>(BEP20) |
| ------------------------------------------------------------------ | -------- | ---------------------------- | ------------------------------- |
| [Ascendex](https://ascendex.com/en/cashtrade-spottrading/usdt/zig) | ✅       | ✅                           | ✅                              |
| [Biconomy](https://www.biconomy.com/exchange/ZIG_USDT)             | ✅       | ✅                           | ❌                              |
| [Bitget](https://www.bitget.com/spot/ZIGUSDT)                      | ❌       | ✅                           | ❌                              |
| [BitMart](https://www.bitmart.com/trade/en?symbol=ZIG_USDT)        | ✅       | ✅                           | ❌                              |
| [Bitpanda](https://www.bitpanda.com/en/prices/zigchain-zig)        | ❌       | ✅                           | ❌                              |
| [Bitvavo](https://bitvavo.com/en/zigchain)                         | ❌       | ✅                           | ❌                              |
| [BloFin](https://blofin.com/spot/ZIG-USDT)                         | ✅       | ✅                           | ❌                              |
| [Bybit](https://www.bybit.com/en/trade/spot/ZIG/USDT)              | ✅       | ✅                           | ❌                              |
| [CoinDCX](https://coindcx.com/trade/ZIGUSDT)                       | ❌       | ✅                           | ❌                              |
| [CoinEx](https://www.coinex.com/en/exchange/zig-usdt)              | ❌       | ✅                           | ❌                              |
| [CoinStore](https://www.coinstore.com/en/trade/ZIG_USDT)           | ✅       | ❌                           | ❌                              |
| [Gate.io](https://www.gate.com/trade/ZIG_USDT)                     | ❌       | ✅                           | ✅                              |
| [GroveX](https://www.grovex.io/en_US/trade/ZIG_USDT)               | ❌       | ✅                           | ❌                              |
| [HTX](https://www.htx.com/trade/zig_usdt)                          | ❌       | ✅                           | ❌                              |
| [Kraken](https://www.kraken.com/prices/zigchain)                   | ❌       | ✅                           | ❌                              |
| [KuCoin](https://www.kucoin.com/trade/ZIG-USDT)                    | ✅       | ❌                           | ❌                              |
| [LBank](https://www.lbank.com/trade/zig_usdt)                      | ❌       | ✅                           | ❌                              |
| [LCX](https://lcx.com/en/trade/ZIG-EUR)                            | ✅       | ✅                           | ❌                              |
| [MEXC](https://www.mexc.com/exchange/ZIG_USDT)                     | ✅       | ✅                           | ✅                              |
| [OurBit](https://www.ourbit.com/exchange/ZIG_USDT)                 | ✅       | ✅                           | ❌                              |
| [Phemex](https://phemex.com/trade/ZIGUSDT)                         | ✅       | ✅                           | ❌                              |
| [Uphold](https://uphold.com/en-us/prices/crypto/zig)               | ❌       | ✅                           | ❌                              |
| [WooX](https://woox.io/en/trade/ZIG_USDT)                          | ❌       | ✅                           | ❌                              |
