---
title: How to Unstake from Old Staking Program
description: Step-by-step guide to unstaking ZIG tokens from the old staking program and migrating to ZIGChain mainnet for enhanced DeFi access and governance participation.
keywords: [unstake ZIG, old staking program, migrate tokens, ZIGChain migration, unstaking guide, token migration, staking withdrawal]
sidebar_position: 7
---
...
- Follow the [ZIG Bridge guide](../users/hub/bridge) to bridge directly from Ethereum to ZIGChain using Axelar
