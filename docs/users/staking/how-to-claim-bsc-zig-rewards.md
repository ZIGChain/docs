...
3. Connect your ZIGChain wallet. If you don't have a ZIGChain wallet yet, [follow this guide to set it up.](../wallet-setup/zigchain-wallet.md)
...
For a detailed step-by-step guide and frequently asked questions about claiming rewards, refer to the [**ZIGStake Rewards guide**](../hub/claim-rewards).
