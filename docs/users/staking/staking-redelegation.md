---
title: Staking Redelegation on ZIGChain
description: Learn how to redelegate staked ZIG tokens between validators without unbonding, including benefits, limitations, cooldown periods, and step-by-step instructions.
keywords:
  [
    redelegation,
    redelegate tokens,
