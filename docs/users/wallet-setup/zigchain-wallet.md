---
title: Set Up a ZIGChain Wallet
description: Step-by-step guide to setting up a ZIGChain wallet using Leap Wallet and Keplr Wallet for both mainnet and testnet networks.
keywords:
  [
    ZIGChain wallet setup,
    ZIGChain supported wallets,
    ZIGChain keplr wallet,
    Cosmos wallets for ZIGChain,
    mnemonic wallet ZIGChain,
    how to add ZIGChain to Keplr,
    best wallet for ZIGChain,
    ZIGChain wallet download,
    connect wallet to ZIGChain network,
  ]
sidebar_position: 5
---

# **Set Up a ZIGChain Wallet**
