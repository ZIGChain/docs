---
title: Multisig Transactions on ZIGChain
description: Comprehensive guide to multi-signature accounts on ZIGChain, including creating multisig accounts, executing transactions, Ledger integration, and security best practices.
keywords:
  [
    multisig,
    multi-signature,
