---
title: ZIGChain Governance
description: Comprehensive guide to ZIGChain governance including proposal submission, voting process, deposit periods, quorum requirements, and how to participate in network decisions.
keywords:
  [
    ZIGChain governance,
    ...
    how does governance work on ZIGChain,
    how to submit a proposal on ZIGChain,
    ZIGChain voting rules,
    ZIG governance module explained,
    ZIGChain blockchain governance,
...
If you want to know more about the governance module, please read this article and then check the [Governance Module](../../builders/governance-module) documentation.
...
- Refer to the [Governance Module](../../builders/governance-module) for detailed parameter values.

## References

- [ZIGChain HUB - Proposals](https://hub.zigchain.com/proposals/)
- [Staking](../staking/staking.md)
- [Governance Module](../../builders/governance-module)
