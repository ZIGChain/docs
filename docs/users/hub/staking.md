---
title: Staking on ZIGChain Hub
description: Step-by-step guide to staking ZIG tokens on ZIGChain Hub, including delegating to validators, claiming rewards, managing stakes, and understanding the 21-day unbonding period.
keywords:
  [
    ZIGChain staking,
    stake ZIG on ZIGChain,
    ZIGChain Hub staking,
    ZIG token staking,
    ...
    how to stake ZIG on ZIGChain,
    step-by-step ZIGChain staking guide,
    how to delegate ZIG tokens to validators,
    how to claim staking rewards on ZIGChain,
  ]
sidebar_position: 3
---
...
1. **Install & Fund a Wallet**  
   Use a ZIGChain-compatible wallet (such as Leap or Kepl) and fund it with ZIG Token. (If you don't have a wallet yet check out this article: [Add ZIGChain Wallet](../wallet-setup/zigchain-wallet))
