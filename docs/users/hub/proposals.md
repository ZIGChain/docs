---
title: Governance Proposals on ZIGChain Hub
description: Complete guide to viewing, exploring, and voting on governance proposals through ZIGChain Hub, including proposal browsing, search, filtering, and voting instructions.
keywords:
  [
    ZIGChain proposals,
    ZIGChain governance proposals,
    ZIGChain Hub proposals,
    ZIGChain community voting,
    ZIGChain proposal list,
    vote on ZIGChain proposals,
    ZIGChain proposal status (passed,
    rejected,
    voting),
    ZIGChain proposal table,
    how to view ZIGChain proposals,
    how to vote on ZIGChain governance proposals,
    ZIGChain proposals overview 2025,
    ZIGChain governance voting interface,
  ]
sidebar_position: 4
---
...
> 📋 **Note**: For detailed information about governance processes, proposal types, and voting mechanics, see the [Governance documentation](../governance).
...
![summary_cards](./img/proposal/proposals_1.png)
...
![search_and_filter](./img/proposal/proposals_2.png)
...
![main_table](./img/proposal/proposals_3.png)
...
![proposal_deposit_general](./img/proposal/proposal_deposit_1.png)
...
![proposal_deposit_detail](./img/proposal/proposal_deposit_2.png)
...
![proposal_header](./img/proposal/proposals_4.png)
...
![voting_summary](./img/proposal/proposals_5.png)
...
![quorum](./img/proposal/proposals_6.png)
...
For detailed governance information, see the [Governance documentation](../governance).
