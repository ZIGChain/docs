---
title: ZIG Rewards Program
description: Guide to claiming staking rewards from the pre-mainnet staking program through ZIGChain Hub, including connection steps, reward claiming, and penalty information.
keywords:
  [
    ZIGChain claim rewards,
    Claim ZIG rewards,
    ZIGChain rewards hub,
    ZIGChain staking rewards claim,
    Claim pre-mainnet staking rewards,
    Bridge ZIG to ZIGChain for rewards,
    ZIGRewards program,
    ZIGChain wallet claim rewards,
    how to claim ZIG rewards on ZIGChain Hub,
    claim staking rewards ZIGChain step by step,
    ZIGChain reward claim guide 2025,
    bridge old ZIG tokens to mainnet and claim rewards,
    zigchain claim rewards page,
    claim ETH/BSC staking rewards zigchain,
    zigchain bridge and claim rewards,
    zigchain rewards eligibility criteria,
    claimable rewards zigchain hub,
  ]
sidebar_position: 5
---
...
- Click **Connect ZIGChain Wallet** in the Hub.
  - If you don't have one yet, [follow this guide on how to set up one](../wallet-setup/zigchain-wallet).
...
For more bridging methods, refer to this [link](https://zignaly.medium.com/be-mainnet-ready-a-step-by-step-guide-to-bridge-zig-to-erc-20-from-bnb-sol-pol-inj-cex-10fbbef98ad2).
