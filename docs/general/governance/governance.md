...
If you want to know more about the governance module, please read this article and then check the [Governance Module](/build/governance-module) documentation.
...
- Refer to the [Governance Module](/build/governance-module) for detailed parameter values.

## References

- [ZIGChain HUB - Proposals](https://hub.zigchain.com/proposals/)
- [Staking](../staking/staking.md)
- [Governance Module](/build/governance-module)
