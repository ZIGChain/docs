...
The timing of validator infractions relative to your unbonding process determines whether you will be slashed:

**If you are bonded (actively staking) → You get slashed**

- When your tokens are actively delegated and the validator commits an infraction, you will get effected by the slashing penalty.

**If you are unbonding before the infraction → You don't get slashed**

- If you initiate unbonding before the validator commits an infraction, and the infraction occurs during your unbonding period, you will not be slashed.

**If you are unbonding after the infraction → You get slashed**

- If the validator commits an infraction while you are still bonded, and you then initiate unbonding afterward, you will still be slashed because you were bonded when the infraction occurred.

### Examples

**Example 1: Safe Unbonding**

- Day 1: You initiate unbonding of 1000 ZIG from Validator A
- Day 5: Validator A commits double signing infraction (5% slashing penalty)
- Day 21: Your 1000 ZIG are released without any slashing
- **Result**: You are not slashed because you were unbonding before the infraction

**Example 2: Slashing After Infraction**

- Day 1: You have 1000 ZIG bonded to Validator B
- Day 10: Validator B commits double signing infraction (5% slashing penalty)
- Day 15: You initiate unbonding (but the validator was already slashed earlier).
- Day 36: Your remaining 950 ZIG are released (after 5% slashing)
- **Result**: You are slashed because you were bonded when the infraction occurred

**Example 3: Active Bonding Slashing**

- Day 1: You have 2000 ZIG bonded to Validator C
- Day 20: Validator C experiences extended downtime and slashed for it (0.01% slashing penalty)
- Day 25: You still have tokens bonded during the slashing event
- **Result**: You are slashed 0.01% (0.2 ZIG) because you were actively bonded during the infraction
